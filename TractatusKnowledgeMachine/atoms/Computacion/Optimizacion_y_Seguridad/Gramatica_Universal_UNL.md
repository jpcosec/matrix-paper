...
## Qué es
Es la especificación para traducir estructuras de significado agnósticas del idioma (como Universal Networking Language - UNL y marcos semánticos) hacia firmas proposicionales canónicas $S$-Expressions y coordenadas matriciales.
...
## Cuándo interviene
Durante el parsing de textos en lenguaje natural de alta complejidad o en la conversión interlingua.
