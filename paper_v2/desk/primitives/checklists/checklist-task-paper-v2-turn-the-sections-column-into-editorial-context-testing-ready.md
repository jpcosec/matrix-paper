---
# checklist-xxx
id: checklist-task-paper-v2-turn-the-sections-column-into-editorial-context-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-paper-v2-turn-the-sections-column-into-editorial-context-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
