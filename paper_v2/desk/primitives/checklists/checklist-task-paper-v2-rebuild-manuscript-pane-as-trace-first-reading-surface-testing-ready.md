---
# checklist-xxx
id: checklist-task-paper-v2-rebuild-manuscript-pane-as-trace-first-reading-surface-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-paper-v2-rebuild-manuscript-pane-as-trace-first-reading-surface-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
