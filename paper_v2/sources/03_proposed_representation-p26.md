# Proposed representation source 26

Kind: current-paper-block
Origin: sections/03_proposed_representation.md
Anchor: 03_proposed_representation-p26
...
Bootstrap source block 26 extracted from the current Proposed representation draft.
