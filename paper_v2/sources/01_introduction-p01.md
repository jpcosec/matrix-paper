# Introduction source 01

Kind: current-paper-block
Origin: sections/01_introduction.md
Anchor: 01_introduction-p01
...
Bootstrap source block 01 extracted from the current Introduction draft.
