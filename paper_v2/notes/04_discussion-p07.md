...
- ../sources/04_discussion-p07.md

## Intent

Bridge source block 07 into section-ready prose for Discussion.

## Claim

Furthermore, a little-explored feature of language is that, by defining a closed set of signs and facts, the mapping of those signs and facts to language can shift from a stochasti
