...
- ../sources/10_appendix-p16.md

## Intent

Bridge source block 16 into section-ready prose for Appendix.

## Claim

If factual errors were outliers in embedding space, post-hoc detection would be easy.
