...
- ../sources/04_discussion-p13.md

## Intent

Bridge source block 13 into section-ready prose for Discussion.

## Claim

Finally, one might ask whether a logic machine with sufficient "knowledge" could replace what LLMs can do today.
