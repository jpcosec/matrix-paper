...
- ../sources/10_appendix-p21.md

## Intent

Bridge source block 21 into section-ready prose for Appendix.

## Claim

In the Tractarian reading that structures our substrate, logical form—"the possibility of structure" (2.033)—is instantiated as the syntax matrix $S_i$: an adjacency operator over
