# State of the Art: Hallucination Mitigation and Representational Geometries note 07

Stage: writing-note

## Sources

- ../sources/01_1_sota-p07.md
- ../sources/kb/01_1_sota-p07__atom-fenomeno-de-gibbs-en-funciones-indicadoras.md
- ../sources/kb/01_1_sota-p07__atom-geometria-de-politopos-y-ancho-acotado-hanin.md
- ../sources/kb/01_1_sota-p07__atom-barrera-deteccion-auroc-error-tipo-iii.md
- ../sources/kb/01_1_sota-p07__atom-representacion-continua-vs-implementacion-discreta.md

## Intent

Bridge source block 07 into section-ready prose for State of the Art: Hallucination Mitigation and Representational Geometries.

## Claim

**Why Continuous Spaces Offer No Guarantee of Logical Validity** The case for discrete primitives rests on three structural observations about continuous approximation.
