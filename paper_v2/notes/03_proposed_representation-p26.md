# Proposed representation note 26

Stage: writing-note

## Sources

- ../sources/03_proposed_representation-p26.md
- ../sources/kb/03_proposed_representation-p26__atom-context-ci.md
- ../sources/kb/03_proposed_representation-p26__atom-relation-ri.md
- ../sources/kb/03_proposed_representation-p26__atom-logicalspace-li.md

## Intent

Bridge source block 26 into section-ready prose for Proposed representation.

## Claim

- $W_i$ is basically a hierarchical routing space that partitions $W_i \cup W'_i$, in other words, a context index over a tensorial logic space where we can identify objects by the
