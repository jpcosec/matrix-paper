---
# checklist-xxx
id: checklist-task-paper-v2-add-editorial-validation-language-and-interruption-cues-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-paper-v2-add-editorial-validation-language-and-interruption-cues-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
