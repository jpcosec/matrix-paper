---
# checklist-xxx
id: checklist-task-paper-v2-reframe-sources-as-evidence-cards-closeout-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-paper-v2-reframe-sources-as-evidence-cards-ready-for-closeout
- condition-task-paper-v2-reframe-sources-as-evidence-cards-has-closeout-evidence
# all | any
mode: all
# e.g., system:deskops
tags:
