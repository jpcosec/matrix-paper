---
# checklist-xxx
id: checklist-task-paper-v2-enforce-paragraph-to-note-to-source-trace-navigation-testing-ready
# draft | active | complete | archived
status: active
# List of condition-xxx paths
condition_refs:
- condition-task-paper-v2-enforce-paragraph-to-note-to-source-trace-navigation-has-validation
# all | any
mode: all
# e.g., system:deskops
tags:
